...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String key_codekurir = "code_kurir";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String create_table_resi = "CREATE TABLE " + table_resi + "("+key_id+" INTEGER PRIMARY KEY autoincrement, "+key_label+" TEXT, "+key_resi+" TEXT, "+key_kurir+" TEXT, "+key_codekurir+" Text, "+key_status+" TEXT)";
    ...
    public ArrayList<ResiModel> getResi(){
        ...
        if (c.moveToFirst()){
            do {
                ...
                resiModel.setCode_kurir(c.getString(4));
                resiModel.setStatus(c.getString(5));
    ...
    public void insert(String label, String resi, String kurir, String code_kurir, String status){
        ...
        if (exist){
            ...
            String query = "INSERT INTO " +table_resi+"("+key_label+","+key_resi+","+key_kurir+","+key_codekurir+","+key_status+")VALUES('"+label+"','"+resi+"','"+kurir+"','"+code_kurir+"','"+status+"')";
    ...
    public void update( String label, String resi, String kurir, String code_kurir, String status){
        SQLiteDatabase database = this.getWritableDatabase();
        String query = "UPDATE "+table_resi+" SET "+key_label+" = '"+label+"',"+key_resi+" = '"+resi+"',"+key_kurir+" = '"+kurir+"',"+key_codekurir+" = '"+code_kurir+"',"+key_status+" = '"+status+"' WHERE " +key_resi+ " = '"+resi+"'";
        database.execSQL(query);
