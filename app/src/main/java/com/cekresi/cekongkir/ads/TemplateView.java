...
public class TemplateView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.native_admob_layout) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.native_admob_layout) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.native_admob_layout);
        } finally {
            attributes.recycle();
        }
